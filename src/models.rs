...
mod tests {
    ...
    fn mask_secret_short_fully_masked() {
        // 12 chars or fewer → all asterisks
    ...
    fn provider_config_masked_hides_api_key() {
        let provider = ProviderConfig {
            name: "test".to_string(),
            api_key: "sk-very-long-secret-key-12345".to_string(),
