...
pub use notes::{
    ...
    // #2832: unlinked mentions support
    find_unlinked_mentions_async,
    find_unlinked_mentions_with_context,
    follow_wikilinks_async,
    follow_wikilinks_with_context,
    import_markdown_async,
    import_markdown_with_context,
    load_context_notes_async,
    load_context_notes_with_context,
    load_note_with_context,
    load_recent_notes_for_overview,
...
pub use collections::{
    ...
    get_collections_for_note_with_context, list_collections_async, list_collections_with_context,
    list_notes_in_collection_async, list_notes_in_collection_with_context, move_collection_async,
...
mod tests {
    ...
    fn import_markdown_adds_to_index() {
        ...
        // #1826: Import source must be inside the vault directory.
        let vault_dir = _temp.join("vault");
        let import_dir = vault_dir.join("import-source");
