...
import { isCJK, CJK_STOP_CHARS } from '../utils/cjk';

// Re-export for backward compatibility (tests import isCJK from rag.ts)
export { isCJK, CJK_STOP_CHARS } from '../utils/cjk';
